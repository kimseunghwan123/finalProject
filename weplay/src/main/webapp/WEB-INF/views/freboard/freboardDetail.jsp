...
<div class="outer">
	...
	<table id="detail-area">
	    ...
	    <tr id="detail_title-area">
	         ...
	         <td class="detail_title_date_td">${freboardOne.createDate}</td>
	    </tr>
	    <!-- 컨텐츠영역 -->
	    <tr id="detail_content-area">
		   <td class="detail_content-area">${freboardOne.boardContent}</td>  
	    </tr>
	     <!-- 게시판유형영역 -->
	    <tr id="board_type-area">
		   <td class="board_type-area">${freboardOne.boardType}</td>  
	    </tr>
	     <!-- 첨부파일영역 -->
	    <tr id="file_path-area">
		   <td class="file_path-area">${freboardOne.filePath}</td>  
	    </tr>
