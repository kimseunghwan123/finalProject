...
public class GameMatchBoardRepository {
	...
	// 경기게시판 등록
	public int regGameMatchBoardInfo(SqlSessionTemplate sqlSession, GameMatchBoard gb) {
		System.out.println("[FreBoardRepository regGanmeMatchBoardInfo] " + gb);
		System.out.println("[FreBoardRepository regGameMatchBoardInfo gb 결과]");
		return sqlSession.insert("gamematchboardMapper.regGameMatchBoard", gb);
	}
